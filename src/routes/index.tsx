...
export const Route = createFileRoute("/")({
    head: () => ({
        meta: [
            { title: "MT Nexus — Run Every Supermarket Branch From One Platform" },
            {
                name: "description",
                content:
            ...
            { property: "og:title", content: "MT Nexus — Multi-Tenant POS for UAE Retail" },
            {
            ...
            <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 pt-16 pb-20 lg:grid-cols-[1fr_1.05fr] lg:px-8 lg:pt-24 lg:pb-28">
                <Reveal>
                    ...
                    <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
                        MT Nexus is a white-label, multi-tenant POS platform that unifies head office, every
                        ...
                        <div className="grid gap-10 p-8 lg:grid-cols-2 lg:p-12">
                            <div>
                                ...
                                <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                                    Every receipt printed by MT Nexus is a valid UAE tax document. VAT is computed
                            ...
                            <div className="rounded-2xl border border-border bg-surface-2 p-6">
                                <div className="mx-auto max-w-sm rounded-2xl border border-border bg-surface p-5 shadow-[var(--shadow-soft)]">
                                    ...
                                    <p className="mt-4 text-center text-[10px] text-muted-foreground">
                                        Generated by MT Nexus · FTA compliant
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section className="py-20 lg:py-28">
            <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 lg:grid-cols-2 lg:px-8">
                <Reveal>
                    ...
                    <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                        MT Nexus tills hold a full local catalog and transaction ledger. When connectivity drops,
            ...
            <div className="mx-auto max-w-7xl px-5 lg:px-8">
                <Reveal>
                    <SectionHead
                        ...
                        copy="Retail data is financial data. MT Nexus treats it that way at every layer."
                    />
                </Reveal>
        ...
        <section id="contact" className="border-t border-border bg-mesh py-20 lg:py-28">
            <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
                <Reveal>
                    ...
                    <h2 className="mt-3 text-3xl font-extrabold text-ink sm:text-4xl">
                        See MT Nexus running your store
                    </h2>
