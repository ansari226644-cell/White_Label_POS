...
export const Route = createFileRoute("/demo/head-office")({
  head: () => ({
    meta: [
      { title: "Head Office Dashboard Demo — MT Nexus" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "MT Nexus Head Office Dashboard Demo" },
            ...
            <div className="mt-4 h-72">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={branchTrend}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="Al Barsha" fill="var(--chart-1)" radius={[6, 6, 0, 0]} />
                  <Bar dataKey="Deira" fill="var(--chart-2)" radius={[6, 6, 0, 0]} />
                  <Bar dataKey="Corniche" fill="var(--chart-3)" radius={[6, 6, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="panel p-6">
              ...
              <div className="mx-auto mt-5 max-w-sm rounded-2xl border border-border bg-surface-2 p-5">
                ...
                <p className="mt-4 flex items-center justify-center gap-1.5 text-[10px] text-muted-foreground">
                  <Receipt className="h-3 w-3" /> Generated by MT Nexus · FTA compliant
                </p>
              </div>
            </div>
          </div>
